...
export default function Edit( {id}: {id : number | string })
{
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(`${Backend_URL}/match-team/${id}`, {
        headers: {
          'Authorization': `Bearer ${access_key}`
        }
      });
  ...
  const addCategory = async () => {
    ...
    try {
      const response = await axios.post(`${Backend_URL}/match-category`, {
        name: categoryTitle
      }, {
        headers: {
          'Authorization': `Bearer ${access_key}`
  ...
  const removeCategory = async () => {
    ...
    try {
      await axios.delete(`${Backend_URL}/match-category/${category}`, {
        headers: {
          'Authorization': `Bearer ${access_key}`
        },
        data: {
  ...
  const handleSubmit = async (e:any) => {
    ...
    axios.patch(`${Backend_URL}/match-team/${id}`, {
      team: {
                  ...
                  <CardContent>
                    <div className="grid gap-6">
                      ...
                      <div className="flex justify-between gap-6">
                        ...
                        <div className="grid gap-3 w-full">
                          <Button variant="destructive" size="sm" onClick={removeCategory} disabled={category === ''}>
