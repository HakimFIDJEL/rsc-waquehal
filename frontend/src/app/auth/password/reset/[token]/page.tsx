...
export default function LoginForm({ params }: {params : { token: string }}) 
 {
  ...
  useEffect(() => {
    ...
    axios.get(`${Backend_URL}/user/password/reset/${params.token}`).then((response) => {
  ...
  const handleSubmit = async (e:any) => {
    ...
    axios.post(`${Backend_URL}/user/password/reset/${params.token}`, {
